    ...
    <section className="mx-auto grid w-full max-w-6xl gap-8 lg:grid-cols-[1.5fr_1fr]">
      <Card className="overflow-hidden border-none bg-gradient-to-br from-primary/90 via-primary to-primary/70 text-primary-foreground shadow-2xl">
        <CardContent className="flex flex-col gap-6 p-10">
          <span className="inline-flex items-center gap-2 text-sm font-semibold uppercase tracking-[0.4em] text-white/70">
          ...
          <div className="flex flex-col gap-4 sm:flex-row">
            <Button
              asChild
              size="lg"
              className="h-12 rounded-full bg-white text-primary hover:bg-white/90"
            >
      ...
      <Card className="border-border/60 bg-white/80 backdrop-blur dark:bg-slate-950/60">
        <CardContent className="flex h-full flex-col justify-between gap-6 p-8">
          <div className="flex flex-col gap-2">
            <span className="flex items-center gap-2 text-sm font-semibold uppercase tracking-[0.35em] text-muted-foreground">
